...
const distanceModelSelector = document.getElementById('distanceModelSelector');
const panningModelSelector = document.getElementById('panningModelSelector');
...
playButton.addEventListener('click', () => {
  ...
  panner.panningModel = panningModelSelector.value;
  panner.distanceModel = distanceModelSelector.value;
  updatePosition();
